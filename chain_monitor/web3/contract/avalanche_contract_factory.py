...
from chain_monitor.web3.contract.contract_factory import CommonControllerContractFunctionsMixin
from chain_monitor.web3.contract.web3_wrapper import ava_web3 as web3


class ControllerContract(CommonControllerContractFunctionsMixin):
    def __init__(self, address):
        if ControllerContract.abi is None:
            with open('./chain_monitor/web3/contract/abi/avalanche_abi/controller_abi.json', 'r') as abi:
